...
exports.loadMessages = exports.clearCache = exports.load = exports.getLoader = undefined;
...
var Message = function Message(data, _ref) {
  var user = _ref.user;
...
var getLoader = exports.getLoader = function getLoader() {
  return new _dataloader2.default(function (ids) {
    return (0, _graphqlMongooseLoader.mongooseLoader)(_model.Message, ids);
  });
};
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            _context.prev = 3;
            _context.next = 6;
            return context.dataloaders.MessageLoader.load(id);
          ...
          case 12:
            return _context.abrupt('return', viewerCanSee() ? new Message(data, context) : null);
...
var clearCache = exports.clearCache = function clearCache(_ref3, id) {
  ...
  return dataloaders.MessageLoader.clear(id.toString());
};

var loadMessages = exports.loadMessages = function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            Messages = _model.Message.find({ conversation: conversation }).sort({ createdAt: -1 });
  ...
  return function loadMessages(_x3, _x4) {
